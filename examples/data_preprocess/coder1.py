...
def leetcode2k():
    ...
    def make_map_fn(split):
        ...
        def process_fn(example, idx):
            question = f"Now the user asks you to solve a coding  problem. After thinking, when you finally reach a conclusion, clearly state the identity of each character within <answer> </answer> tags.  Please solve the programming task below using a self-contained code snippet in a markdown code block.\n\n{example['meta']['query'].strip()}"
